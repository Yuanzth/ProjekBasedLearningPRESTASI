...
CREATE PROCEDURE sp_GetAllDosenDetails
AS
BEGIN
    SELECT 
        id_dosen, 
...
CREATE PROCEDURE sp_AddDosen
    @NIP VARCHAR(20),
    @nama_dosen NVARCHAR(100),
    @email VARCHAR(50),
    @no_telp VARCHAR(30),
    @id_admin INT
AS
BEGIN
    ...
    VALUES (@NIP, @nama_dosen, @email, @no_telp, @id_admin);
END;

-- Menghapus data dosen berdasarkan id_dosen
